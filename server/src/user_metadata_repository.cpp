...
UserMetadataRepository::UserMetadataRepository(PostgresDBManager& postgres_db_manager, const std::string& connection_name) : BaseRepository(postgres_db_manager), connection_name(connection_name) {
